<div id="sidebar_menu">
    ...
    <div class="sb-setting">
        ...
        <div class="hs-toggles">
                    ...
                    <a href="<?=$websiteUrl?>/random" rel="nofollow" class="hst-item" data-toggle="tooltip" data-original-title="Select Random Anime">
...
<div id="header" class="header-home ">
    <div class="container">
        ...
        <div class="header-setting">
            <div class="hs-toggles">
                <a href="<?=$websiteUrl?>/anime" class="hst-item" data-toggle="tooltip" data-original-title="Anime List">
                    <div class="hst-icon"><i class="fas fa-list"></i></div>
                    <div class="name"><span>Anime</span></div>
                </a>
                <a href="<?=$websiteUrl?>/popular" class="hst-item" data-toggle="tooltip" data-original-title="Popular Anime List">
                ...
                <div id="user_menu" class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-item dropdown-item-user">
                        <div class="user-detail">
                            <div class="name"><strong><?php echo $fetch['name']; ?></strong></div>
                            <div class="mail"><a  class="__cf_email__"><?php echo $fetch['email']; ?></a>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="grid-menu">
                        <a class="dropdown-item" href="<?=$websiteUrl?>/user/profile"><i class="fas fa-user mr-2"></i>Profile</a>
                        <a class="dropdown-item" href="<?=$websiteUrl?>/user/watchlist"><i class="fas fa-heart mr-2"></i>Watch List</a>
                        <a class="dropdown-item" href="<?=$websiteUrl?>/user/changepass"><i class="fas fa-cog mr-2"></i>Change
                            Password</a>
                        <div class="clearfix"></div>
                        
                    </div>
                    <a class="dropdown-item text-right text-white" href="<?=$websiteUrl?>/user/logout">Logout<i class="fas fa-arrow-right ml-2 mr-1"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="header_right">
                <div id="user-slot">
                    <div class="header_right-user">
                        <a href="<?=$websiteUrl?>/user/login" class="btn-user btn btn-sm btn-primary btn-login">Login</a>
                    </div>
                </div>
            </div> 
        <?php } ?>
